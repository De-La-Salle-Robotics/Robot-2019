...
public class Pixy2CCC
{
    ...
    // PIXY_SIG1 | PIXY_SIG5
    public final int CCC_SIG1 = 1;
    public final int CCC_SIG2 = 2;
    public final int CCC_SIG3 = 4;
    public final int CCC_SIG4 = 8;
    public final int CCC_SIG5 = 16;
    public final int CCC_SIG6 = 32;
    public final int CCC_SIG7 = 64;
    public final int CCC_COLOR_CODES = 128;

    private final int CCC_SIG_ALL = 0xff; // all bits or'ed together
    ...
    {
        return parseBlocks(CCC_SIG_ALL, 0xFF);
    }

    public int parseBlocks(int sigmap)
    {
        return parseBlocks(sigmap, 0xFF);
    }

    public int parseBlocks(int sigmap, int maxBlocks)
    {
        numBlocks = 0;
